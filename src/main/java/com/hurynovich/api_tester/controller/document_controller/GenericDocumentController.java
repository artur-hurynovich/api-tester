package com.hurynovich.api_tester.controller.document_controller;
...
public class GenericDocumentController<D extends AbstractDocument, I> {

    private final Validator<D> validator;

    private final DocumentService<D, I> service;

    public GenericDocumentController(final Validator<D> validator, final DocumentService<D, I> service) {
