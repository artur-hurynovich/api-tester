...
public class UrlUtilsImplTest {
	...
	public void urlUtilsImplRemoveParametersTest() {
		Assertions.assertEquals(URL_NO_PARAMETERS, URL_UTILS.clearParameters(URL_NO_PARAMETERS));
		Assertions.assertEquals(URL_NO_PARAMETERS, URL_UTILS.clearParameters(URL_WITH_PARAMETERS_PREFIX));
		Assertions.assertEquals(URL_NO_PARAMETERS, URL_UTILS.clearParameters(URL_WITH_ONE_PARAMETER));
		Assertions.assertEquals(URL_NO_PARAMETERS, URL_UTILS.clearParameters(URL_WITH_TWO_PARAMETERS));
	}
